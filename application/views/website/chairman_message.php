...
<head>
    ...
    <title>Who we are || Message from Chairman || Ghitha</title>
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header" style="background-image: url(<?php echo base_url(); ?>public_html/front_end/assets/images/backgrounds/page-header-contact.jpg);">
            <div class="container">
                <h2>Message from Chairman & CEO</h2>
            </div>
        </section>
        ...
        <section class="best_company">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-xl-5">
                        <div class="company_image">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/gbn_Mohammed-Somar-Ajalyaqin.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class="company_content">
                            <div class="block-title text-left">
                                ...
                                <h3>Mohammed Somar Ajalyaqin</h3>
                                <p>&#8211; Chairman, Ghitha Holding</p>
                                <div class="leaf">
                            ...
                            <div class="benefits_text">
                                <p>
                                    With the UAE's National Food Security Strategy aiming to make the Emirates the world's most food-secure nation by 2051, expanding operations in food and agriculture presents an ideal opportunity to deliver shareholder value through commercial success
                                    while supporting the national development agenda. This transformation of Zee Stores into Ghitha Holding represents the next stage in the company's journey, and through our growing operations we will continue to play
                                    an even greater role in this sector.
                                </p>
                                <!--<p>&#8211; Mohammed Somar Ajalyaqin<br />&#8211; Chairman, Ghitha Holding</p>-->
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mb-5">
                    <div class="col-xl-7 order-2 order-md-1">
                        <div class="company_content">
                            <div class="block-title text-left">
                                <!--<h3>Message from CEO</h3>-->
                                <h3>Falal Ameen</h3>
                                <p>&#8211; CEO, Ghitha Holding</p>
                                <div class="leaf">
                                    <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/resources/leaf.png" alt="">
                                </div>
                            </div>
                            <div class="benefits_text">
                                <p>
                                    Ghitha Holding was destined to set the benchmark for retail service quality. Ghitha Holding has consistently grown in income, benefit, and resources. Buyers want the greatest products and services in a highly competitive retail market with more companies
                                    than ever. To guarantee long-term relationships, we want to give our clients cutting-edge solutions and innovations. With proactive customer and employee satisfaction programs, we enhance our authoritative excellence
                                    and quality consciousness. We managed to gain a solid market position and became a preferred partner for many global companies.
                                </p>
                                <p>
                                ...
                                <!--<p>&#8211; Falal Ameen<br />&#8211; CEO, Ghitha Holding</p>-->
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 order-1 order-md-2">
                        <div class="company_image mr-md-0 ml-md-5">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/chairman-and-ceo.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-xl-5">
                        <div class="company_image">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/chief-finance-officer.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-7">
                        <div class="company_content">
                            <div class="block-title text-left">
                                <!--<h3>Message from The Chairman</h3>-->
                                <h3>Mr. Shaji Philip</h3>
                                <p>&#8211; Chief Finance Officer, Ghitha Holding</p>
                                <div class="leaf">
                                    <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/resources/leaf.png" alt="">
                                </div>
                            </div>
                            <div class="benefits_text">
                                <p>Mr. Shaji has completed bachelor’s degree in science (Mathematics) and a Chartered Accountancy degree from the Institute of Chartered Accountants of India. He plays a strategic role in the overall management of the company and have the primary day-to-day responsibility for planning, implementing, managing and controlling all financial-related activities of the company with direct responsibility towards accounting, finance, forecasting, strategic planning, job/project costing, legal, deal analysis and negotiations, and institutional financing.</p>
                                <!--<p>&#8211; Mohammed Somar Ajalyaqin<br />&#8211; Chairman, Ghitha Holding</p>-->
                            </div>
                        </div>
                    </div>
