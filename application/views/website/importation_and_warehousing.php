...
<head>
    ...
    <title>Importation and Warehousing || Services || Ghitha</title>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>public_html/front_end/assets/images/favicon-ghitha-logo.png"><?php echo base_url(); ?>public_html/front_end/
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header" style="background-image: url(<?php echo base_url(); ?>public_html/front_end/assets/images/backgrounds/page-header-contact.jpg);">
            <div class="container">
                <h2>Importation and Warehousing</h2>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="company_image wow fadeInUp">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/service/service-import-and-warehouse.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="company_content">
                            <div class="company_content">
                                <div class="block-title text-left">
                                    ...
                                    <h3 class="wow fadeInUp">Importation and Warehousing</h3>
                                    <div class="leaf wow fadeInUp">
                                        <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/resources/leaf.png" alt="">
                                    </div>
                                </div>
                                <p class="wow fadeInUp">
                                    With our over 15 years of successful experience in international import, we are specialized in importation of premium brands of food products.
                                </p>
                                <p>
                                    For our importation, we rely on reputed Suppliers and Manufacturers across the world including USA, Thailand, Brazil, Saudi Arabia, Oman etc 10.
                                </p>
                                <p>
                                    Ghitha Holding operates from 5 warehouses 3 in KIZAD and 2 in MASDAR with a total storage capacity of 11,268 M3. This includes 1,063 M3 of cold storage area and 405 M3 chilled storage area, facilitated with all the modern techniques and well planned storage
                                    for easy access to all the items. Our Warehouses comply with all safety, health and environmental practices required by the International Quality Standards and HACCP Standards for Food products. A routine supervision
                                    system for inspecting the risk of perishable food stuffs, hence assuring the maintenance of excellent quality till delivered.
                                </p>
                            </div>
                        </div>
                    </div>
