...
<head>
    ...
    <title>Non Food Items || Services || Ghitha</title>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="company_image wow fadeInUp">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/service/services-non-food-items.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="company_content">
                            <div class="company_content">
                                <div class="block-title text-left">
                                    ...
                                    <h3 class="wow fadeInUp">Non Food Items</h3>
                                    <div class="leaf wow fadeInUp">
                                        <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/resources/leaf.png" alt="">
                                    </div>
                                </div>
                                <p class="wow fadeInUp">
                                    Ghitha Holding aims to make your lives more comfortable and happier with all the facilities for your daily needs. Our products are for improving quality of life and we offer you product categories like:
                                </p>
                                <ul class="company_list_box list-unstyled">
                                    <li class="wow fadeInUp" data-wow-delay="100ms"><i class="fa fa-check"></i>Stationery</li>
                                    <li class="wow fadeInUp" data-wow-delay="120ms"><i class="fa fa-check"></i>Cosmetics</li>
                                    <li class="wow fadeInUp" data-wow-delay="140ms"><i class="fa fa-check"></i>Computer Accessories</li>
                                    <li class="wow fadeInUp" data-wow-delay="160ms"><i class="fa fa-check"></i>Toiletries</li>
                                    <li class="wow fadeInUp" data-wow-delay="180ms"><i class="fa fa-check"></i>Cigarettes</li>
                                    <li class="wow fadeInUp" data-wow-delay="200ms"><i class="fa fa-check"></i>Home Essentials</li>
                                    <li class="wow fadeInUp" data-wow-delay="220ms"><i class="fa fa-check"></i>Disposable Items</li>
                                    <li class="wow fadeInUp" data-wow-delay="240ms"><i class="fa fa-check"></i>Detergents & Chemicals</li>
                                    <li class="wow fadeInUp" data-wow-delay="260ms"><i class="fa fa-check"></i>Hygienic Products (Sanitizer, Face Mask, Gloves etc.)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
