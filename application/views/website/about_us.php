...
<head>
    ...
    <title>About || Ghitha</title>
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicon-ghitha-logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicon-ghitha-logo.png">
    ...
    <div class="page-wrapper">
                                ...
                                <ul class=" main-nav__navigation-box">
                                    ...
                                    <li class="dropdown current">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="<?php echo $chairman_message_link; ?>">Message From The
                                                    Chairman & CEO</a></li>
        ...
        <section class="about_two">
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-5 col-md-5">
                        <div class="block-title text-left">
                            <p class="wow fadeInUp">About Ghitha</p>
                            <h3 class="wow fadeInUp">We're Providing The Best Solution</h3>
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-7">
                        <div class="about_two_text wow fadeInUp">
                            <p>
                                Ghitha Holding is an eminent trading and distribution firm operating as a retail
                                subsidiary under IHC Abu Dhabi. Our specialization ranges from food to non-food produce
                                and
                                provides boundless services, including importing, trading, wrapping, storage, and more.
                                We use advanced cold-storage equipment in our warehouses and logistic processes.
                                Possessing over 10,000 products, we are proudly one of the top traders in the market
                                while continuously evolving based on customer preferences. We supply quality products
                                and food trading services by following HACCP and international standards of excellence
                                for food safety and hygiene and have been accredited by ISO 9001:2015. Our products
                                are imported from world-renowned manufacturers like the United States of America,
                                Thailand, Brazil, Saudi Arabia, and Oman.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row my-5">
                    <div class="col-xl-12">
                        <div class="cta_three_content wow fadeInUp" data-wow-delay="100ms">
                            <div class="cta_three_text">
                                <h2>We prioritize time and quality every step of the way, to assure our customers of the
                                    best products.</h2>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <p class="wow fadeInUp">
                            International Holding Company (IHC) was founded in 1998 with a goal to diversify as a
                            distributor and grow the non-oil business sectors in the UAE. In compliance with 'Abu
                            Dhabi's Vision 2030', the ADX listed company aims to implement several initiatives such
                            as sustainability, innovation and economic diversification across what is now considered
                            as one of the region's largest restricted 2 conglomerates. IHC has a vision to enhance its'
                            portfolio through acquisitions, business combinations and strategic investments. IHC is
                            extremely proud to consist of 30 entities with future plans to diversify holdings across
                            several growing industries such as Real Estate, Healthcare, Agriculture, Utlities, Food &
                            Beverage, IT & Communications, Retail, Capital and Leisure.
                        </p>
                        <p class="wow fadeInUp">
                            IHC's primary focus is to enhance shareholder value and achieve significant growth in the
                            coming years. Operational synergies and maximizing cost effectiveness across all
                            verticals is where they thrive, furthermore, consistently evaluating investment
                            opportunities through various means like direct ownership and securing partnerships in
                            the UAE and internationally. While the world is changing every second, IHC focuses on
                            resilience, innovation, and reshaping the marketplace for its own company, clients, and
                            partners.
                        </p>
                    </div>
                </div>
                <div class="row mt-3 mt-md-5">
                    <div class="col-xl-5 col-lg-5">
                        <div class="about_two_left wow fadeInUp" data-wow-delay="100ms">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/about/about_page_left-img.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5">
                        <div class="about_two_middle wow fadeInUp" data-wow-delay="130ms">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/about/about_page_middle-img.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-2 col-lg-2">
                        <div class="about_two-right wow fadeInUp" data-wow-delay="160ms">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/about/about_page_right-img.jpg" alt="">
                            <div class="about_two_content">
                                <h2>We are proudly one of the top traders in the market</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="video-one" style="background-image:url(<?php echo base_url(); ?>public_html/front_end/assets/images/resources/video-bg-1.jpg);">
            <div class="container text-center">
                <!-- <a href="https://www.youtube.com/watch?v=Vagc5qqm1_o" class="video-one__btn video-popup wow fadeInUp"><i class="fa fa-play"></i></a> -->
                <p class="wow fadeInUp">The new strategic direction</p>
                <h3 class="wow fadeInUp">Largest in the regional<br>food trading sector</h3>
            </div>
        </section>

        <section class="cta-one mt-170" style="background-image: url(<?php echo base_url(); ?>public_html/front_end/assets/images/resources/cta_one_bg-1.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="cta_one_content">
                            <h1 class="wow fadeInUp">PPROVIDE YOU WITH THE HIGHEST QUALITY  PRODUCTS THAT MEETS YOUR
                                EXPECTATION</h1>
                            <p class="wow fadeInUp">HACCP and international standards of excellence</p>
                            <div class="cta_one__button-block wow fadeInUp">
