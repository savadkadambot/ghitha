...
<head>
    ...
    <title>Logistics || Services || Ghitha</title>
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="company_image wow fadeInUp">
                            <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/service/services-logistics.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="company_content">
                            <div class="company_content">
                                <div class="block-title text-left">
                                    ...
                                    <h3 class="wow fadeInUp">Logistics Department</h3>
                                    <div class="leaf wow fadeInUp">
                                        <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/resources/leaf.png" alt="">
                                    </div>
                                </div>
                                <p class="wow fadeInUp">
                                    Being committed to the Quality Services, our logistics department operates dedicated fleet of 18 delivery vehicles which are equipped with freezers and chillers and supports our supply chain with latest technology, assuring the quality of products delivered.
                                    As such Ghitha Holding has developed a continually expanding Client base and Supply List, with our excellent distribution network of multi-client, we provide our clients unparalleled flexibility to manage their dynamic
                                    distribution requirement. We ensure delivery of your products to the Right Place, at the Right Time and at the Right Price, which makes a difference.
                                </p>
                            </div>
                        </div>
                    </div>
