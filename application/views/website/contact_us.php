...
<body>
                        ...
                        <div class="contact-form d-flex align-items-center justify-content-center">
                            <div class="have_questions">
                                ...
                                <div class="block-title text-center">
                                    ...
                                    <div class="leaf wow fadeInUp">
                                        <form action="">
                                            <input placeholder="&nbsp;&nbsp;Name" type="text" name="name" class="w-100" required>
                                            <input placeholder="&nbsp;&nbsp;Email" type="email" name="email" class="w-100" required>
                                            <input placeholder="&nbsp;&nbsp;Subject" type="text" class="w-100" required>
                                            <textarea placeholder="&nbsp;&nbsp;Message" class="w-100 " name="" id="" cols="30" rows="5" required></textarea>
                                            <input type="submit" name="submit" value="submit" class="w-100"></input>
                                        </form>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="https://www.google.com/recaptcha/api.js?render=6LdJlo0gAAAAANxkN3W403HU7tMZqdbKkeOulgGf"></script>
    <script src="<?php echo base_url(); ?>public_html/front_end/assets/js/captcha.js"></script>
    <!-- captcha script -->
