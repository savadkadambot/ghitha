                ...
                <div class="row">
                        ...
                        <div class="blog_one_single wow fadeInUp" data-wow-delay="300ms">
                            <div class="blog_one_image">
                                <div class="blog_image">
                                    <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/blog/6.jpg" alt="Blog One Image">
                                ...
                                <div class="blog-one__content">
                                    ...
                                    <h3><a href="investors-need-to-keep-an-eye-on-abu-dhabis-international-holding-co-and-its-subsidiaries.html">Investors need to keep an eye on Abu Dhabi's International Holding Co. and its subsidiaries</a></h3>
                                    ...
                                    <div class="read_more_btn">
                                        <a href="investors-need-to-keep-an-eye-on-abu-dhabis-international-holding-co-and-its-subsidiaries.html"><i class="fa fa-angle-right"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="blog_one_single wow fadeInUp" data-wow-delay="600ms">
                            <div class="blog_one_image">
                                <div class="blog_image">
                                    <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/blog/oxford-nanopore-300x217.jpg" alt="Blog One Image">
                                    <div class="blog_one_date_box">
                                        <p>Nov 9, 2020</p>
                                    </div>
                                </div>
                                <div class="blog-one__content">
                                    ...
                                    <h3><a href="abu-dhabis-ihc-invests-51m-in-uks-oxford-nanopore-technologies.html">Abu Dhabi's IHC invests $51m in UK's Oxford Nanopore Technologies</a></h3>
                                    <div class="blog_one_text">
                                    ...
                                    <div class="read_more_btn">
                                        <a href="abu-dhabis-ihc-invests-51m-in-uks-oxford-nanopore-technologies.html"><i class="fa fa-angle-right"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="blog_one_single wow fadeInUp" data-wow-delay="900ms">
                            <div class="blog_one_image">
                                <div class="blog_image">
                                    <img src="<?php echo base_url(); ?>public_html/front_end/assets/images/blog/businessman-analyzing-company-financial-report-balance-with-digital-augmented-reality-graphics_34141-379-300x169.jpg" alt="Blog One Image">
                                    <div class="blog_one_date_box">
                                        <p>Nov 9, 2020</p>
                                    </div>
                                </div>
                                <div class="blog-one__content">
                                    ...
                                    <h3><a href="earnings-release-1h-2020.html">Earnings Releases 1H 2020</a></h3>
                                    <div class="blog_one_text">
                                    ...
                                    <div class="read_more_btn">
                                        <a href="earnings-release-1h-2020.html"><i class="fa fa-angle-right"></i>Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-6">
                        <div class="footer-widget__column footer-widget__link wow fadeInUp" data-wow-delay="200ms">
                            ...
                            <ul class="footer-widget__links-list list-unstyled">
                                <li><a href="<?php echo base_url(); ?>index.php/Web/about_us">About Us</a></li>
                                <li><a href="<?php echo base_url(); ?>index.php/Web/chairman_message">Chairman & CEO</a></li>
                                <!-- <li><a href="our-team.html">Our Team</a></li> -->
                                <li><a href="<?php echo base_url(); ?>index.php/Web/news_and_media">News & Media</a></li>
                                <li><a href="<?php echo base_url(); ?>index.php/Web/contact_us">Contact</a></li>
                            </ul>
                        </div>
                    </div>
